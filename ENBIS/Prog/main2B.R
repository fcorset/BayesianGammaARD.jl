...
# PLOT 
par(mfrow = c(2, 3))
hist(x = Output[, 1], probability = TRUE, main = "", xlab = alpha)
lines(density(x = Output[, 1]), lwd = 2)
abline(v = alpha, col = "red", lwd = 2)
hist(x = Output[, 2], probability = TRUE, main = "", xlab = alpha)
lines(density(x = Output[, 2]), lwd = 2)
abline(v = beta, col = "red", lwd = 2)
hist(x = Output[, 3], probability = TRUE, main = "", xlab = alpha)
lines(density(x = Output[, 3]), lwd = 2)
abline(v = b, col = "red", lwd = 2)
hist(x = Output[, 4], probability = TRUE, main = "", xlab = alpha)
lines(density(x = Output[, 4]), lwd = 2)
abline(v = rho, col = "red", lwd = 2)
hist(x = Output[, 5], probability = TRUE, main = "", xlab = alpha)
lines(density(x = Output[, 5]), lwd = 2)
abline(v = rho_w, col = "red", lwd = 2)
hist(x = Output[, 6], probability = TRUE, main = "", xlab = alpha)
