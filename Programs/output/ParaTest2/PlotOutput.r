...
for (i in 1:NbFic) {
  ...
  FicOut <- paste("Output.plot-cas",NumCas,".pdf", sep = "")
  pdf(FicOut)
  ...
  if (NumCas == 1) {
    titre <- expression(paste("Case 1 (original data): ", alpha, "= 1.0, ", beta, "= 1.0, ",b, "= 1.0, ",rho, "= 0.2"))
  }
  if (NumCas == 2) {
    titre <- expression(paste("Case 2 (original data): ", alpha, "= 1.0, ", beta, "= 1.0, ",b, "= 1.0, ",rho, "= 0.5"))
  }
  if (NumCas == 3) {
    titre <- expression(paste("Case 3 (original data): ", alpha, "= 1.0, ", beta, "= 1.0, ",b, "= 1.0, ",rho, "= 0.8"))
  }
  if (NumCas == 4) {
    titre <- expression(paste("Case 4 (original data): ", alpha, "= 1.0, ", beta, "= 0.5, ",b, "= 1.0, ",rho, "= 0.2"))
  }
  if (NumCas == 5) {
    titre <- expression(paste("Case 5 (original data): ", alpha, "= 1.0, ", beta, "= 0.5, ",b, "= 1.0, ",rho, "= 0.5"))
  }
  if (NumCas == 6) {
    titre <- expression(paste("Case 6 (original data): ", alpha, "= 1.0, ", beta, "= 0.5, ",b, "= 1.0, ",rho, "= 0.8"))
  }
  if (NumCas == 7) {
    titre <- expression(paste("Case 7 (original data): ", alpha, "= 1.0, ", beta, "= 1.2, ",b, "= 1.0, ",rho, "= 0.2"))
  }
  if (NumCas == 8) {
    titre <- expression(paste("Case 8 (original data): ", alpha, "= 1.0, ", beta, "= 1.2, ",b, "= 1.0, ",rho, "= 0.5"))
  }
  if (NumCas == 9) {
    titre <- expression(paste("Case 9 (original data): ", alpha, "= 1.0, ", beta, "= 1.2, ",b, "= 1.0, ",rho, "= 0.8"))
  }
  ...
  # }
  # if (NumCas == 4) {
  #   titre <- expression(paste("Case 4 (transformed data): ", alpha, "= 1.0, ", beta, "= 0.5, ",b, "= 1.0, ",rho, "= 0.2"))
  # }
  # if (NumCas == 5) {
  #   titre <- expression(paste("Case 5 (transformed data): ", alpha, "= 1.0, ", beta, "= 0.5, ",b, "= 1.0, ",rho, "= 0.5"))
  # }
  # if (NumCas == 6) {
  #   titre <- expression(paste("Case 6 (transformed data): ", alpha, "= 1.0, ", beta, "= 0.5, ",b, "= 1.0, ",rho, "= 0.8"))
  # }
  # if (NumCas == 7) {
  ...
  # }
  # if (NumCas == 4) {
  #   titre <- expression(paste("Case 4 (transformed and normalized data): ", alpha, "= 1.0, ", beta, "= 0.5, ",b, "= 1.0, ",rho, "= 0.2"))
  # }
  # if (NumCas == 5) {
  #   titre <- expression(paste("Case 5 (transformed and normalized data): ", alpha, "= 1.0, ", beta, "= 0.5, ",b, "= 1.0, ",rho, "= 0.5"))
  # }
  # if (NumCas == 6) {
  #   titre <- expression(paste("Case 6 (transformed and normalized data): ", alpha, "= 1.0, ", beta, "= 0.5, ",b, "= 1.0, ",rho, "= 0.8"))
  # }
  # if (NumCas == 7) {
