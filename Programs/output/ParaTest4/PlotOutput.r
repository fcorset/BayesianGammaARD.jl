...
for (i in 1:NbFic) {
  ...
  if (NumCas == 4) {
    titre <- expression(paste("Case 4 (original data): ", alpha, "= 1.0, ", beta, "= 0.75, ",b, "= 1.0, ",rho, "= 0.2"))
  }
  if (NumCas == 5) {
    titre <- expression(paste("Case 5 (original data): ", alpha, "= 1.0, ", beta, "= 0.75, ",b, "= 1.0, ",rho, "= 0.5"))
  }
  if (NumCas == 6) {
    titre <- expression(paste("Case 6 (original data): ", alpha, "= 1.0, ", beta, "= 0.75, ",b, "= 1.0, ",rho, "= 0.8"))
  }
  if (NumCas == 7) {
