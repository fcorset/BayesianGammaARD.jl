...
df10_rho0_2 = CSV.read("examples/Results/Convex/sim_data_full_$rho_label.csv", DataFrame)[1:10,:]
df25_rho0_2 = CSV.read("examples/Results/Convex/sim_data_full_$rho_label.csv", DataFrame)[1:25,:]
df50_rho0_2 = CSV.read("examples/Results/Convex/sim_data_full_$rho_label.csv", DataFrame)[1:50,:]
df75_rho0_2 = CSV.read("examples/Results/Convex/sim_data_full_$rho_label.csv", DataFrame)[1:75,:]
df100_rho0_2 = CSV.read("examples/Results/Convex/sim_data_full_$rho_label.csv", DataFrame)[1:100,:]
df125_rho0_2 = CSV.read("examples/Results/Convex/sim_data_full_$rho_label.csv", DataFrame)[1:125,:]
df150_rho0_2 = CSV.read("examples/Results/Convex/sim_data_full_$rho_label.csv", DataFrame)[1:150,:]
df175_rho0_2 = CSV.read("examples/Results/Convex/sim_data_full_$rho_label.csv", DataFrame)[1:175,:]
df200_rho0_2 = CSV.read("examples/Results/Convex/sim_data_full_$rho_label.csv", DataFrame)[1:200,:]


# Plot de la dégradation simulée
plot(df200_rho0_2.tinsp, df200_rho0_2.deg, label="Simulated degradation", xlabel="Time", ylabel="Degradation level", title="Simulated degradation process (ρ=0.2)")
hline!([3], label="l_PM")
hline!([6], label="l_CM")
...
CSV.write("examples/Results/Convex/sim_data_full_$rho_label.csv", df200_rho0_2)

n_values = [10,25,50,75,100,125,150,175,200]
for i in 1:length(res_NI_all_rho0_2)
    CSV.write("examples/Results/Convex/bayes_posterior_non_informative_n$(n_values[i])_$rho_label.csv", res_NI_all_rho0_2[i])
    CSV.write("examples/Results/Convex/bayes_posterior_good_priors_n$(n_values[i])_$rho_label.csv", res_GP_all_rho0_2[i])
    CSV.write("examples/Results/Convex/bayes_posterior_bad_priors_n$(n_values[i])_$rho_label.csv", res_BP_all_rho0_2[i])
end
...
CSV.write("examples/Results/Convex/mle_results_$rho_label.csv", mle_df_rho_0_2)
