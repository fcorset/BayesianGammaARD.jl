...
df10_rho0_2 = CSV.read("examples/Results/Homogeneous/sim_data_full_$rho_label.csv", DataFrame)[1:10,:]
df25_rho0_2 = CSV.read("examples/Results/Homogeneous/sim_data_full_$rho_label.csv", DataFrame)[1:25,:]
df50_rho0_2 = CSV.read("examples/Results/Homogeneous/sim_data_full_$rho_label.csv", DataFrame)[1:50,:]  
df75_rho0_2 = CSV.read("examples/Results/Homogeneous/sim_data_full_$rho_label.csv", DataFrame)[1:75,:]  
df100_rho0_2 = CSV.read("examples/Results/Homogeneous/sim_data_full_$rho_label.csv", DataFrame)[1:100,:]    
df125_rho0_2 = CSV.read("examples/Results/Homogeneous/sim_data_full_$rho_label.csv", DataFrame)[1:125,:]
df150_rho0_2 = CSV.read("examples/Results/Homogeneous/sim_data_full_$rho_label.csv", DataFrame)[1:150,:]
df175_rho0_2 = CSV.read("examples/Results/Homogeneous/sim_data_full_$rho_label.csv", DataFrame)[1:175,:]
df200_rho0_2 = CSV.read("examples/Results/Homogeneous/sim_data_full_$rho_label.csv", DataFrame)[1:200,:]          
